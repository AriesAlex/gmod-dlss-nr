...
Совместная работа поставляемого native runtime подтверждена **8 сентября 2026**: успешный DLSS-RR в 03:55:26, DLSS-NR count=1 в 03:55:27 и count=100 в 03:57:49, оба с `RR guides selected`. Выход — 2560×1440, глубина и motion vectors — 1707×960. Это проверка конкретного запуска; после переноса повтори её на новой установке.
